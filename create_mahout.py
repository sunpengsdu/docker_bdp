...
if len(sys.argv) < 4:
	...
	print 'usage: [application_name] [mahout_version] [worker number] \n'
	exit()
...
if version == 'mahout-0.7':
	image = docker_repo + '/' + 'hadoop-cdh4.7' + '-web'
	image_master = docker_repo + '/' + "mahout-0.7-web"
else:
...
app_redis.hset('bdp_apps', app_name, 'mahout')
