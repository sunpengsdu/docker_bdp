...
if len(sys.argv) < 4:
	print 'usage: [application_name] [graphlab_version] [worker number]'
...
if version == 'graphlab-2.2':
        image = docker_repo + '/' + version + '-web3'
else:
...
app_redis.hset('bdp_apps', app_name, 'graphlab')
