...
def sync_file(ip, master_flag=0):
	...
	filename_list.append('yarn-site.xml')
...
if version == 'yarn-cdh4.7':
	image = docker_repo + '/' + version + '-web-v3'
else:
...
f1 = open(workdir + 'yarn-site.xml', 'w')
f1.write("<?xml version=\"1.0\"?> \n")
f1.write("<?xml-stylesheet type=\"text/xsl\"href=\"configuration.xsl\"?> \n")
f1.write("<configuration>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.aux-services</name>\n")
f1.write("\t\t<value>mapreduce.shuffle</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.aux-services.mapreduce.shuffle.class</name>\n")
f1.write("\t\t<value>org.apache.hadoop.mapred.ShuffleHandler</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.resourcemanager.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":8032</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.resourcemanager.scheduler.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":8030</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.resourcemanager.resource-tracker.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":8031</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.resourcemanager.admin.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":8033</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.resourcemanager.webapp.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":8088</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.application.classpath</name>\n")
f1.write("\t\t<value>/opt/cdh4.7.0/etc/hadoop,/opt/cdh4.7.0/share/hadoop/common/*,/opt/cdh4.7.0/share/hadoop/common/lib/*,/opt/cdh4.7.0/share/hadoop/hdfs/*,/opt/cdh4.7.0/share/hadoop/hdfs/lib/*,/opt/cdh4.7.0/share/hadoop/yarn/*,/opt/cdh4.7.0/share/hadoop/yarn/lib/*</value>\n")
f1.write("\t</property>\n")


f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.local-dirs</name>\n")
f1.write("\t\t<value>/opt/yarn/local</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.log-dirs</name>\n")
f1.write("\t\t<value>/opt/yarn/log</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.remote-app-log-dir</name>\n")
f1.write("\t\t<value>/cluster_data/"+app_name+"/apps</value>\n")
f1.write("\t</property>\n")
...
f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.app.mapreduce.am.staging-dir</name>\n")
f1.write("\t\t<value>/cluster_data/"+app_name+"/</value>\n")
f1.write("\t</property>\n")


f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.resource.percentage-physical-cpu-limit</name>\n")
f1.write("\t\t<value>5</value>\n")
f1.write("\t</property>\n")


f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.resource.cpu-vcores</name>\n")
...
f1.write("\t<property>\n")
f1.write("\t\t<name>yarn.nodemanager.resource.memory-mb</name>\n")
f1.write("\t\t<value>2096</value>\n")
f1.write("\t</property>\n")
...
f1.write("\t<property>\n")
f1.write("\t\t<name>mapreduce.framework.name</name>\n")
f1.write("\t\t<value>yarn</value>\n")
f1.write("\t</property>\n")


f1.write("\t<property>\n")
f1.write("\t\t<name>mapreduce.jobhistory.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":10020</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>mapreduce.jobhistory.webapp.address</name>\n")
f1.write("\t\t<value>"+container_pt_master[app_name + '-master']['ip'] +":19888</value>\n")
f1.write("\t</property>\n")
...
slave_ip_list=[]
for slave_name in slave_name_list:
#	print container_pt_slave[slave_name]['ip']
...
app_redis.hset('bdp_apps', app_name, 'yarn')
...
a,b,c = ssh.exec_command("/opt/cdh4.7.0/sbin/start-yarn.sh")
print c.read()

a,b,c = ssh.exec_command("/opt/cdh4.7.0/sbin/mr-jobhistory-daemon.sh start historyserver")
print c.read()
