...
def sync_file(ip, master_flag=0):
	...
	if master_flag == 0:
		...
		remotepath = "/opt/hive-0.13.1/conf/" + "hive-site.xml"
        	localpath  = workdir + "hive-site.xml"
        	sftp.put(localpath,remotepath)	

		remotepath = "/opt/" + "hive_hwi.sh"
        	localpath  = workdir + "hive_hwi.sh"
        	sftp.put(localpath,remotepath)	
...
if version == 'hive-0.13.1':
	image = docker_repo + '/' + 'hadoop-cdh4.7' + '-web'
	image_master = docker_repo + '/' + "hive-0.13.1-mysql-v2"
else:
...
print 'the master node is created from image:      ',  image_master
print 'the slave nodes are created from image:      ', image
...
sys.stdout.flush()
try:
	container_return = docker_client.create_container(image=image_master, name=app_name + '-master', hostname=app_name + '-master', mem_limit='4g')
...
f1 = open(workdir + 'hive_hwi.sh', 'w')
f1.write("sleep 1; nohup /opt/hive-0.13.1/bin/hive --service hwi > /dev/null 2>&1 &")
f1.flush()
f1.close()



f1 = open(workdir + 'hive-site.xml', 'w')
f1.write("<?xml version=\"1.0\"?> \n")
f1.write("<?xml-stylesheet type=\"text/xsl\"href=\"configuration.xsl\"?> \n")
f1.write("<configuration>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>hive.metastore.warehouse.dir</name>\n")
f1.write("\t\t<value>/cluster_data/"+app_name+"/warehouse</value>\n")
f1.write("\t</property>\n")


f1.write("\t<property>\n")
f1.write("\t\t<name>hive.hbase.snapshot.restoredir</name>\n")
f1.write("\t\t<value>/cluster_data/"+app_name+"/tmp</value>\n")
f1.write("\t</property>\n")

f1.write("\t<property>\n")
f1.write("\t\t<name>hive.exec.scratchdir</name>\n")
f1.write("\t\t<value>/cluster_data/"+app_name+"/hive</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>hive.hwi.war.file</name>\n")
f1.write("\t\t<value>lib/hive-hwi-0.12.0.war</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>hive.user.install.directory</name>\n")
f1.write("\t\t<value>hdfs:///cluster_data/"+app_name+"/user</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>javax.jdo.option.ConnectionURL</name>\n")
f1.write("\t\t<value>jdbc:mysql://localhost/metastore</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>javax.jdo.option.ConnectionDriverName</name>\n")
f1.write("\t\t<value>com.mysql.jdbc.Driver</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>javax.jdo.option.ConnectionUserName</name>\n")
f1.write("\t\t<value>hive</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>javax.jdo.option.ConnectionPassword</name>\n")
f1.write("\t\t<value>111111</value>\n")
f1.write("\t</property>\n")



f1.write("\t<property>\n")
f1.write("\t\t<name>datanucleus.autoCreateSchema</name>\n")
f1.write("\t\t<value>false</value>\n")
f1.write("\t</property>\n")


f1.write("\t<property>\n")
f1.write("\t\t<name>datanucleus.fixedDatastore</name>\n")
f1.write("\t\t<value>true</value>\n")
f1.write("\t</property>\n")
f1.write("</configuration>\n")
f1.flush()
f1.close()
...
app_redis.hset('bdp_apps', app_name, 'hive')
...
a,b,c = ssh.exec_command("/opt/cdh4.7.0/bin/start-mapred.sh")
print c.read()
ssh.close()
